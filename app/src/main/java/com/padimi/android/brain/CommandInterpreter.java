...
public final class CommandInterpreter {
    ...
    private boolean isVolumeUp(String s) {
        return s.contains("volume up") || s.contains("turn up the volume") ||
                s.contains("turn the volume up") || s.contains("increase volume") ||
                s.contains("increase the volume") || s.contains("raise the volume") ||
                s.contains("turn on the volume") || s.equals("turn on volume") ||
                s.equals("louder") || s.equals("make it louder") || s.equals("make the sound louder");
    }

    private boolean isVolumeDown(String s) {
        return s.contains("volume down") || s.contains("turn down the volume") ||
                s.contains("turn the volume down") || s.contains("decrease volume") ||
                s.contains("decrease the volume") || s.contains("lower the volume") ||
                s.equals("quieter") || s.equals("make it quieter") || s.equals("make the sound quieter");
    }
